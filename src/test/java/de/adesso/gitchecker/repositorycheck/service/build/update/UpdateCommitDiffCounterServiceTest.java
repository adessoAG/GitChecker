...
class UpdateCommitDiffCounterServiceTest {

    @Autowired
    private UpdateCommitDiffCounterService commitDiffCounters;
    @Autowired
    ...
    @Test
    void commitsBeforeAndBehindBeingAssigned() {
        //Given
        ...
        //When
        commitDiffCounters.update(resources.getTargetRepository());

        //Then
        resources.getTargetRepository().getBranches().values().forEach(branch ->
                System.out.println(branch.getName() + "\n\tBefore: " + branch.getCommitsBeforeDefault() + "\n\tBehind: " + branch.getCommitsBehindDefault() + "\n")
        );
    }
}
